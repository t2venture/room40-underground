...
class DocumentDto:
    ...
    document = api.model('document', {
        ...
        'title': fields.String(required=False, description='document title'),
        'contents': fields.String(required=False, description='document controls'),
    })
...
class PropertyDto:
    ...
    property = api.model('property', {
        ...
        'majorcity': fields.String(required=False, description='majorcity'),
        'building_sqft_area': fields.String(required=False, description='property building area'),
        'gross_sqft_area': fields.String(required=False, description='property total area'),
        'address': fields.String(required=False, description='property address'),
        'latitude': fields.String(required=False, description='latitude of the property'),
        'longitude': fields.String(required=False, description='longitude of the property'),
        ...
        'zipcode': fields.String(required=False, description='zipcode of the house'),
        'photos': fields.String(required=False, description='photos of the house - webpage links'),
        'market_price': fields.String(required=False, description='market price'),
        'listed': fields.String(required=False, description='whether it is listed or not'),
        'ann_mortgage_cost': fields.String(required=False, description='annual mortgage cost'),
        'estimated_rent': fields.String(required=False, description='estimated rent'),
        'cap_rate': fields.String(required=False, description='cap rate'),
        'yield_rate': fields.String(required=False, description='yield rate'),
        'lasso_score': fields.String(required=False, description='lasso score'),
        'lasso_property': fields.String(required=False, description='lasso property subscore'),
        'lasso_economics': fields.String(required=False, description='lasso economics subscore'),
        'lasso_location': fields.String(required=False, description='lasso location subscore'),
        'lasso_macro': fields.String(required=False, description='lasso macro subscore'),
        'hoa_fee': fields.String(required=False, description='hoa fee'),
        'hoa_rent': fields.String(required=False, description='hoa_rent'),
        'est_property_tax': fields.String(required=False, description='estimated property tax'),
        'est_insurance': fields.String(required=False, description='estimated insurance')
    })
...
class PropertyModelDto:
    ...
    property_model = api.model('property_model', {
        ...
        'property_id': fields.String(required=False, description='property_id'),
        'project_oneyear': fields.String(required=False, description='project_oneyear'),
        'project_twoyear': fields.String(required=False, description='project_twoyear'),
        'project_fiveyear': fields.String(required=False, description='project_fiveyear'),
        'threemonth_corr': fields.String(required=False, description='seasonal trend for 3 months'),
        'sixmonth_corr': fields.String(required=False, description='seasonal trend for 6 months'),
...
class PortfolioDto:
    ...
    portfolio = api.model('portfolio_model', {
        'id': fields.String(required=False, description='id'),
        'title': fields.String(required=False, description='title of the portfolio'),
        'description': fields.String(required=False, description='description of portfolio'),
    })
...
class TeamPortfolioDto:
    ...
    team_portfolio=api.model('team_portfolio', {
        ...
        'portfolio_id': fields.String(required=True, description = 'id of portfolio'),
        'role': fields.String(required=False, description='role of the team in this portfolio'),
    })
...
class RentDto:
    ...
    rent=api.model('rent', {
        ...
        'bedroom_count': fields.String(required=False, description='number of bedrooms in the rent unit'),
        'bathroom_count': fields.String(required=False, description='number of bathrooms in the rent unit'),
        'rounded_sqft_area': fields.String(required=False, description='area in sq ft rounded to the nearest 100'),
...
class TeamDto:
    ...
    team=api.model('team', {
        ...
        'name': fields.String(required=False, description='name of the team'),
